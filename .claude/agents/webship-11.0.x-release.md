...
description: >
  ...
  webship-drupal-module-release, webship-drupal-theme-release, drupalcode-issue-manager, drupalcode-mr-manager.
...
released), pick the type from the title. See drupalcode-issue-manager.
...
issues→drupalcode-issue-manager, MRs→drupalcode-mr-manager (github.com→github-pr-manager).
